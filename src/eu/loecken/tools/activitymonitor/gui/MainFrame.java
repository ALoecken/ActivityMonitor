...
public class MainFrame extends JFrame implements ClipboardOwner {
                        ...
                        layout
                            ...
                            .addGroup(
                                layout
                                    ...
                                    .addComponent(lblCountHours, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(btnMerge, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGap(18)
                            .addGroup(
                                layout
                                    .createParallelGroup(Alignment.TRAILING, false)
                                    .addComponent(btnCopy, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(btnDelete, GroupLayout.DEFAULT_SIZE, 119,
        ...
        layout
            ...
            .addGroup(
                layout
                    ...
                    .addComponent(txtHours, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
            ...
            .addGroup(
                layout
                    .createParallelGroup(Alignment.LEADING, false)
                    .addComponent(btnMerge, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                        Short.MAX_VALUE)
                    .addComponent(btnDelete, GroupLayout.PREFERRED_SIZE, 63,
                        GroupLayout.PREFERRED_SIZE))
            .addPreferredGap(ComponentPlacement.UNRELATED)
            .addGroup(
                layout.createParallelGroup(Alignment.BASELINE).addComponent(lblCountHours)
                    .addComponent(btnCopy)).addContainerGap()));
  ...
  public boolean containsTimeSpan(TimeSpan ts) {
    return timeList.contains(ts);
  }
    ...
    if (size > 0) {
      ...
      if (targetHourText.length() > 0) {
        ...
        try {
          ...
          Logger.getLogger(MainFrame.class.getName()).log(Level.WARNING, "Could not parse \"{0}\"",
              targetHourText);
          this.txtHours.setText("");
        } catch (Exception ex) {
          Logger.getLogger(MainFrame.class.getName()).log(Level.SEVERE,
              "Could not parse \"" + targetHourText + "\"", ex);
        }
